...
// Routes
//when i launch this function  thi root directory will be triggerd
app.get("/", (req, res) => {
  return res.status(200).send("welcome to cloud function server");
});
// create
// Post
...
// what ever we are requestiong that need to be exported to firebase cloud function
